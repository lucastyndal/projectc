...
LDDEPS = link/stm32f446.ld link/stm32_generic.ld
...
CFLAGS = $(ARCHFLAGS) $(FFLAGS) -O0 -Os -Wall -Wdouble-promotion -D_ISOC99_SOURCE
...
$(ELF).nocrc : $(OBJS) $(LDDEPS)
	...
	@arm-none-eabi-$(LINKER) $(ARCHFLAGS) $(OBJS) -T$(LDSCRIPT) -o $@

$(ELF) : $(CRCOBJS)
	@mkdir -p $(dir $@)
	@echo -n "LINK $(CRCOBJS) => $@\n"
	@arm-none-eabi-$(LINKER) $(ARCHFLAGS) $(CRCOBJS) -T$(LDSCRIPT) -o $@
